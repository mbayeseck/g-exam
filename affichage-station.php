...
<div class="wrapper">
	...
	//	include('file_session.php');
        ...
        $reponse=$bdd->query("SELECT S.codeSite,P.nomPet,S.nomSite,Z.nomZone,S.adresseSite,S.villeSite,S.contactSite FROM Site S 
									LEFT JOIN Petrolier P ON P.codePet=S.codePet
									LEFT JOIN Zone Z ON Z.idZone=S.idZone");
	?>
                ...
                <div class="box box-default">
					...
					<table id="example" class="display" cellspacing="0" width="100%">
						...
						<tr>
                            ...
                            <td><?=$row['nomSite']?></td>
							<td><?=$row['nomZone']?></td>
							<td><?=$row['adresseSite']?></td>
							<td><?=$row['villeSite']?></td>
							<td><?=$row['contactSite']?></td>
